...
For Senegal we selected 2015 for both polygon incidence data (46 regions) and prevalence data (216 surveys, 8,114). % update todo
...
Thus this cross-validation scheme directly addresses the question of whether the joint model is preferable to using just polygon incidence data.
...
However, in areas of low prevalence, small or moderately sized prevalence point-surveys can be noisy or insensitive and so care must be taken when interpreting predictive performance on these data.
