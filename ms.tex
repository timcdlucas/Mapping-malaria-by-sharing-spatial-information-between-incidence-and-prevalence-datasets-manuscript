...
\begin{flushleft}
{\Large
\textbf\newline{Mapping malaria by sharing spatial information between incidence and prevalence datasets} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
