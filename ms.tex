...
For Indonesia we selected 2012 for surveillance data ($n = 380$) and 2010 for  prevalence data ($n = 969$).
For Senegal we selected 2015 for both surveillance data ($n = 46$) and prevalence data ($n = 216$). % update todo
Finally, for Madagascar we selected 2013 for both surveillance ($n = 110$) and prevalence ($n = 290$) data.
...
Maps of the Indonesian input data_and spatially out-of-sample predictions (Figures~\ref{predobsmapidn}A and C) suggest the that the broad spatial patterns were once again recovered.
