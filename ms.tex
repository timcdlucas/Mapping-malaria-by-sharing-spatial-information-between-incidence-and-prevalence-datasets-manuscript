...
Routine surveillance data, of disease case counts, is becoming more widely available and of better quality \cite{sturrock2016mapping, ohrt2015information, cibulskis2011worldwide}.
Surveillance data is commonly aggregated, reporting disease case counts that occurred within a certain geographic region defined by a polygon.
...
However, the unstructured nature data collection and reporting from national disease surveillance systems means that dealing with biases and data gaps is an ongoing research priority \cite{battle2016treatment, cibulskis2011worldwide}.
...
The class of models that aim to estimate high-resolution maps from aggregated data are called disaggregation models and are characterised by having a variable number of pixels, and therefore multiple rows of covariate data, per row of response data.
...
Wilson \emph{et al.} \cite{wilson2017pointless} use an approximation to represent a downscaling model as a convolution matrix within R-INLA \cite{INLA} but more generally, downscaling models are not available in popular software packages and must be programmed explicitely.
...
The model has seperate likelihood functions for the two data types.
...
\thickhline 
Incidence & Pearson & Indonesia & 0.28 & 0.46 &  0.42\\
&& Senegal & 0.28 & 0.79 &  0.83\\
&& Madagascar & 0.69 & 0.72 &  0.75\vspace{1mm}\\
& Spearman & Indonesia & 0.39 & 0.75 &  0.75\\
&& Senegal & 0.46 & 0.69 &  0.66\\
&& Madagascar & 0.81 & 0.83 &  0.85\vspace{3mm} \\
Prevalence & Pearson & Indonesia & 0.32 & 0.31 &  0.19\\
&& Senegal & 0.06 & 0.04 &  0.04\\
&& Madagascar & 0.57 & 0.55 &  0.59\vspace{1mm}\\
& Spearman & Indonesia & 0.54 & 0.38 &  0.39\\
&& Senegal & 0.03 & 0.12 &  0.12\\
&& Madagascar & 0.57 & 0.55 &  0.58\\
\end{tabular}
\begin{flushleft}
...
{\bf Holdout data} & {\bf Metric} & {\bf Country} &  {\bf Points} & {\bf Polygons} & {\bf Joint} \\
\thickhline 
Incidence & Pearson & Indonesia &  0.07 &  0.09 &   0.16\\
&& Senegal &  0.20 &  0.23 &   0.53\\
&& Madagascar &  0.20 &  0.16 &   0.24\vspace{1mm}\\
& Spearman & Indonesia &  0.40 &  0.47 &   0.39\\
&& Senegal &  0.36 &  0.30 &   0.56\\
&& Madagascar &  0.49 &  0.50 &   0.52\vspace{3mm} \\
Prevalence & Pearson & Indonesia & -0.23 & -0.07 &   0.06\\
&& Senegal &  0.16 &  0.19 &   0.16\\
&& Madagascar &  0.23 &  0.17 &   0.21\vspace{1mm}\\
& Spearman & Indonesia & -0.35 & -0.05 &  -0.01\\
&& Senegal &  0.02 &  0.16 &   0.13\\
&& Madagascar &  0.44 &  0.38 &   0.43\\
\end{tabular}
\begin{flushleft}
Correlation (Spearman's and Pearson's) of predicted incidence rate and prevalence against out-of-sample observed data for three countries.
...
A-B) Indonesia, C-D) Senegal, E-F) Madagascar. A, C, E) log10 aggregated incidence, B, D, F) prevalence.
...
\thickhline 
Incidence & Random & Indonesia & 0.10 & 0.76 &  0.77\\
&& Senegal & 0.69 & 0.82 &  0.78\\
&& Madagascar & 0.73 & 0.82 &  0.78\vspace{1mm}\\
& Spatial & Indonesia & 0.10 & 0.76 &  0.77\\
&& Senegal & 0.69 & 0.82 &  0.78\\
&& Madagascar & 0.73 & 0.82 &  0.78\vspace{3mm} \\
Prevalence & Random & Indonesia & 0.83 & 0.59 &  0.77\\
&& Senegal & 0.87 & 0.69 &  0.80\\
&& Madagascar & 0.83 & 0.69 &  0.80\vspace{1mm}\\
& Spatial & Indonesia & 0.54 & 0.36 &  0.38\\
&& Senegal & 0.87 & 0.69 &  0.80\\
&& Madagascar & 0.83 & 0.69 &  0.80\\
\end{tabular}
\begin{flushleft}
