...
Advantageously, the routine surveillance data can be more sensitive than prevalence point-surveys in low transmission areas because the entire public health system is being used to passively monitor disease occurrence \citep{cibulskis2011worldwide}.
...
Where species specific reports were given, these were used, and in reports that did not distinguish between species of \emph{Plasmodium} the national estimate of the ratio between \emph{P. falciparum} and \emph{P. vivax} cases was used to estimate numbers of \emph{P. falciparum} cases specifically. 
...
For Senegal we selected 2015 for polygon incidence data (41 administrative units) and 2013 to 2017 for prevalence data (804 surveys, 17,037 individuals).
Finally, for Madagascar we selected 2013 for polygon incidence (110 administrative units) and 2011 to 2015 for prevalence data (1,049 surveys, 36,411 individuals).
...
The incidence data (left), predicted incidence from the prevalence GP model for spatially cross-validated out-of-sample polygons (middle) and predicted incidence from the joint model for spatially cross-validated out-of-sample polygons (right) for Senegal.
}
...
The incidence data (left), predicted incidence from the prevalence GP model for spatially cross-validated out-of-sample polygons (middle) and predicted incidence from the joint model for spatially cross-validated out-of-sample polygons (right) for Madagascar.
}
...
Incidence data and predicted incidence maps.
The incidence data (top), predicted incidence from the prevalence GP model for spatially cross-validated out-of-sample polygons (middle) and predicted incidence from the joint model for spatially cross-validated out-of-sample polygons (bottom) for Indonesia.
}
\end{figure}
...
Future models could potentially be improved by using a more flexible approach for addressing the shortcomings in the prevalence-incidence relationship \citep{cameron2015defining}.
