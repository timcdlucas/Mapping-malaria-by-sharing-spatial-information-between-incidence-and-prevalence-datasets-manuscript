...
We find that in most cases there is no difference in mean absolute error between the models.
...
Plots of this prior are shown in S32-33.
...
& Madagascar  & 39.06 &  {\bf 35.82} &  39.01\vspace{3mm}\\
Spatial & Indonesia & {\bf 14.77} &  {\bf 14.77} &  16.46\dag\\
& Senegal  & 13.09 &  {\bf 12.21} &  15.15\dag\\
& Madagascar & 67.73 &  50.38\dag &  {\bf 44.05}\dag\\
\end{tabular}}
\end{table}
...
However, the benefits here were only seen in Madagascar, a country with more intermediate transmission intensities.
In the future, two types of study region might particularly benefit from the methods presented here.
Firstly countries like Madagascar with intermediate transmission intensities and good surveillance data and good prevalence data.
