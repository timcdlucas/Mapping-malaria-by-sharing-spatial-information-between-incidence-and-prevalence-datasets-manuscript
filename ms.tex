...
As the prevalence surveys cover different are ranges they were standardised using the model from [@].
...
\includegraphics[width = 0.9\textwidth]{figures/mdg_points_and_polygons.png}
\caption{{\bf Madagascar polygon data and predictions from the combined model.}
...
\caption{{\bf Indonesia polygon data and predictions from the combined model.}
Figure caption text here, please use this space for the figure panel descriptions instead of using subfigure commands. A: Lorem ipsum dolor sit amet. B: Consectetur adipiscing elit.}
\label{fig1}
\end{figure}
