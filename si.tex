...
\makebox{\includegraphics[width = 1\textwidth]{figures/random_cv_poly_facet.pdf}  }
...
\includegraphics[width =  0.8\textwidth]{figures/spatial_pc_density.png}
...
\includegraphics[width =  0.8\textwidth]{figures/spatial_pc_logdensity.png}
...
\includegraphics[width =  0.8\textheight]{figures/random_cv_model_error.pdf}

\caption{
Density plots of the model errors on random CV hold out data.
The x-axis on the Indonesia plot is artifically cut at -1 and 1.
}
\label{rnd_cv_error}
\end{figure}
...
\includegraphics[width =  0.8\textheight]{figures/spatial_cv_model_error.pdf}

\caption{
Density plots of the model errors on random CV hold out data.
The x-axis on the Indonesia plot is artifically cut at -40.
It can be seen that there is a bias towards overpredicting the small API values in Indonesia in the joint model. 
Overall however this was the least biased model.
The joint model in Senegal is not clearly biased but just has larger errors in general.
}
}
\label{spat_cv_errors}
\end{figure}
...
\includegraphics[width =  0.8\textheight]{figures/mdg_model_error_vs_observed.pdf}

\caption{
Plot of prediction error against observed API for Madagascar.
In this case the joint model was significantly better than the baseline.
We can see that the baseline model underpredicts high incidence areas and overpredicts low incidence areas.
The underprediction of low incidence areas is reduced in the other two models.
}
...
\includegraphics[width =  0.8\textheight]{figures/idn_model_error_vs_observed.pdf}
...
\includegraphics[width =  0.8\textheight]{figures/sen_model_error_vs_observed.pdf}
...
\includegraphics[width =  0.8\textwidth]{figures/java_only.pdf}
...
\includegraphics[width =  1\textwidth, trim = ]{figures/sen_error_plot.pdf}
